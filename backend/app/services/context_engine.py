...
class ContextEngine:
    ...
    async def get_children(self, urn: str, edge_types: Optional[List[str]] = None, limit: int = 100, offset: int = 0) -> List[GraphNode]:
        return await self.provider.get_children(urn, entity_types=None, edge_types=edge_types, limit=limit, offset=offset)
