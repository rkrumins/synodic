...
SEED_CATEGORIES: list[dict[str, Any]] = [
    ...
    {"id": "semantic_layers", "label": "Semantic Layers", "icon": "Layers", "color": "violet", "sort_order": 11, "preview": True, "preview_label": DEFAULT_PREVIEW_LABEL, "preview_footer": DEFAULT_PREVIEW_FOOTER},
